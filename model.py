...
def make_tgt_mask(
    ...
    # 3) combine: True if EITHER pad OR future  -> [batch, 1, tgt_len, tgt_len]
...
class Transformer(nn.Module):
    ...
    def infer(self, src_sentence: str) -> str:
        ...
        toks    = [t.text.lower() for t in self.spacy_de.tokenizer(src_sentence)]
